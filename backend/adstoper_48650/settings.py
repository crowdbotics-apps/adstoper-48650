"""
Django settings for adstoper_48650 project.
...
ROOT_URLCONF = 'adstoper_48650.urls'
...
WSGI_APPLICATION = 'adstoper_48650.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "AdStoper Support <support@adstoper-48650.botics.co>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "adstoper_48650 API",
    "DESCRIPTION": "API documentation for adstoper_48650 App",
    "VERSION": "v1",
}
